...
fig.add_trace(go.Surface(
    ...
    opacity=0.2, showscale=False, name="Feasible Plane",
    colorscale=[[0, 'orange'], [1, 'orange']]
))  # Index: num_data_points

fig.add_trace(go.Surface(
    x=xx, y=yy, z=get_plane(w_opt, b_opt),
    opacity=0.3, showscale=False, name="Optimized Plane",
...
combinations.append(([True] * num_data_points + [False, False, True, True], "Hide Feasible & Optimized"))
combinations.append(([True] * num_data_points + [True, True, False, False], "Hide Both Margins"))
combinations.append(([True] * num_data_points + [False, True, False, True], "Hide Feasible & Margin +1"))
combinations.append(([True] * num_data_points + [False, True, True, False], "Hide Feasible & Margin -1"))
combinations.append(([True] * num_data_points + [True, False, False, True], "Hide Optimized & Margin +1"))
combinations.append(([True] * num_data_points + [True, False, True, False], "Hide Optimized & Margin -1"))
...
# === Save HTML
fig.write_html("svm_3d_planes_with_multiple_toggles.html")
print("✅ Plot saved to 'svm_3d_planes_with_multiple_toggles.html'")